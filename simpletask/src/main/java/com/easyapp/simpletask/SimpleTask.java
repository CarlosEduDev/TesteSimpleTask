package com.easyapp.simpletask;
...
public abstract class SimpleTask<Params, Post, Result> implements Runnable{
    ...
    protected final void postProgressTask(final Post... post) {
